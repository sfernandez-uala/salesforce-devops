...
describe('c-v360-shell card pinning', () => {
    ...
    it('carries no pin control on the rail -- pin management lives on the gallery tiles', async () => {
        ...
        expect(element.shadowRoot.querySelector('[data-id="rail-pin-toggle"]')).toBeNull();
    });
