...
module.exports = {
    ...
    moduleNameMapper: {
        ...
        '^lightning/emptyState$': '<rootDir>/test/jest-mocks/lightning/emptyState/emptyState',
        ...
        '^@salesforce/apex$': '<rootDir>/test/jest-mocks/apex/apex',
        ...
        '^c/v360Styles$': '<rootDir>/view360/main/default/lwc/v360Styles/v360Styles.css'
    }
};
